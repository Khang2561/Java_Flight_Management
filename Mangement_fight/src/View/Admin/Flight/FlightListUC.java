...
public class FlightListUC extends JPanel {
	...
	public FlightListUC() throws ClassNotFoundException, SQLException {
		...
		btnNewButton.setBounds(1354, 11, 106, 35);
