...
public class CreateFlightTicket extends JPanel {
    ...
    public CreateFlightTicket() {
        ...
        createButton.setBounds(41, 300, 100, 50);
        add(createButton);
    }
